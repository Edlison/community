package xyz.edlison.community.advice;
...
import xyz.edlison.community.DTO.ResultDTO;
...
public class CustomizeExceptionHandler {
    ...
    ModelAndView handle(Throwable e, Model model, HttpServletRequest request, HttpServletResponse response) {
        ...
        if ("application/json".equals(contentType)) {//contentType可能为null,只能equals(contentType)
            //返回json
            ResultDTO resultDTO;
